...
This catalog is meant to be consumed by agents that create other agents. The
only thing such an agent needs is the
...
2. That skill carries the full knowledge of how to exploit this catalog: it
...
use-case hierarchy — it holds the skills about the catalog itself.
